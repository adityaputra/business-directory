...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-primary">
      ...
      <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="<?php echo base_url();?>admin/user/add" method="post" enctype="multipart/form-data">
          <div class="box-body">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="role" name="role" placeholder="Select role">
                    <option value="0" <?php echo set_select('role', '0'); ?>>Administrator</option>
                    <option value="1" <?php echo set_select('role', '1'); ?>>Business owner</option>
                    <option value="2" <?php echo set_select('role', '2'); ?>>Contributor</option>
                    <option value="5"  <?php echo set_select('role', '5', TRUE); ?>>User</option>
                  </select>
                </div>
              </div>
              <!-- /col -->
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="twitter" name="twitter" placeholder="Username" value="<?php echo set_value('twitter'); ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="facebook" name="facebook" placeholder="URL" value="<?php echo set_value('facebook'); ?>">
                  </div>
                </div>
                <div class="form-group">
