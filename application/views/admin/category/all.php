              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <!-- <li><a href="<?php echo base_url();?>admin/category/detail/<?php echo urlencode(base64_encode($value['category_id']));?>">Detail</a></li> -->
                    <li><a href="<?php echo base_url();?>admin/category/edit/<?php echo urlencode(base64_encode($value['category_id']));?>">Edit</a></li>
                    <li class="divider"></li>
                    <li><a href="#" onclick="confirm_delete('<?php echo base_url();?>admin/category/delete/<?php echo urlencode(base64_encode($value['category_id']));?>')">Remove</a></li>
                  </ul>
                </div>
              </td>
            </tr>
